    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonCalculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                calculateLuasJajargenjang();
            }
        });
    }

    private void calculateLuasJajargenjang() {
        ...
        if (strAlas.isEmpty() || strTinggi.isEmpty()) {
            Toast.makeText(this, "Masukkan panjang alas dan tinggi terlebih dahulu", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        textViewResult.setText(String.format("Luas Jajargenjang: %.2f", luas));
    }
}
